...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($admin /*&& password_verify($mot_de_passe, $admin['mot_de_passe'])*/) {
            ...
            header("Location: ../util/publier.php");
            exit();
        } else {
...
<body class="align">
    <div class="grid">
        <h1 class="align">Connexion Admin</h1>
        ...
        <form action="login_admin.php" method="POST" class="form login">
            ...
            <p class="text--center">Vous n'avez pas encore de compte? <a href="inscription_admin.php">Inscrivez-vous.</a> 
                <svg class="icon">
